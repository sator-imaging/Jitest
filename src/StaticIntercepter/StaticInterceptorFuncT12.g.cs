...
public sealed class StaticInterceptorFuncT12<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
{
    ...
    internal StaticInterceptorFuncT12(Interceptor interceptor)
    {
...
public static partial class StaticInterceptorExtensions
{
    ...
    public static StaticInterceptorFuncT12<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> StaticJitest<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(this Type type, string methodName, out Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>? originalMethod)
    {
        ...
        var interceptor = type.Jitest<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>(methodName, out originalMethod);
        return new StaticInterceptorFuncT12<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(interceptor);
    }
}
