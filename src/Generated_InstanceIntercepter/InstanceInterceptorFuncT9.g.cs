...
public sealed class InstanceInterceptorFuncT9<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
    ...
    readonly Func<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9> originalMethodInternal;

    internal InstanceInterceptorFuncT9(Interceptor interceptor, Func<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9> originalMethodInternal)
    {
...
public static partial class InstanceInterceptorExtensions
{
    ...
    public static InstanceInterceptorFuncT9<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9> InstanceJitest<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this TTarget instance, string methodName, out Func<T1, T2, T3, T4, T5, T6, T7, T8, T9> originalMethod)
    {
        ...
        var interceptor = instance.Jitest<Func<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9>>(methodName, out var originalMethodInternal);
        originalMethod = (t1, t2, t3, t4, t5, t6, t7, t8) => originalMethodInternal.Invoke(instance, t1, t2, t3, t4, t5, t6, t7, t8);
        return new InstanceInterceptorFuncT9<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9>(interceptor, originalMethodInternal);
    }
}
