...
public sealed class InstanceInterceptorFuncT4<TTarget, T1, T2, T3, T4>
{
    ...
    readonly Func<TTarget, T1, T2, T3, T4> originalMethodInternal;

    internal InstanceInterceptorFuncT4(Interceptor interceptor, Func<TTarget, T1, T2, T3, T4> originalMethodInternal)
    {
