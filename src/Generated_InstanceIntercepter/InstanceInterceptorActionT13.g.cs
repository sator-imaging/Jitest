...
public sealed class InstanceInterceptorActionT13<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
{
    ...
    readonly Action<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> originalMethodInternal;

    internal InstanceInterceptorActionT13(Interceptor interceptor, Action<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> originalMethodInternal)
    {
...
public static partial class InstanceInterceptorExtensions
{
    ...
    public static InstanceInterceptorActionT13<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> InstanceJitest<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(this TTarget instance, string methodName, out Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> originalMethod)
    {
        ...
        var interceptor = instance.Jitest<Action<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>>(methodName, out var originalMethodInternal);
        ...
        return new InstanceInterceptorActionT13<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(interceptor, originalMethodInternal);
    }
}
