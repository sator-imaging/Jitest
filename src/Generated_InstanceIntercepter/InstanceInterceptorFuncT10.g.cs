...
public sealed class InstanceInterceptorFuncT10<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
{
    ...
    readonly Func<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> originalMethodInternal;

    internal InstanceInterceptorFuncT10(Interceptor interceptor, Func<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> originalMethodInternal)
    {
...
public static partial class InstanceInterceptorExtensions
{
    ...
    public static InstanceInterceptorFuncT10<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> InstanceJitest<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this TTarget instance, string methodName, out Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> originalMethod)
    {
        ...
        var interceptor = instance.Jitest<Func<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>(methodName, out var originalMethodInternal);
        originalMethod = (t1, t2, t3, t4, t5, t6, t7, t8, t9) => originalMethodInternal.Invoke(instance, t1, t2, t3, t4, t5, t6, t7, t8, t9);
        return new InstanceInterceptorFuncT10<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(interceptor, originalMethodInternal);
    }
}
