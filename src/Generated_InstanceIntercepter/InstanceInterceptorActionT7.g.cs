...
public sealed class InstanceInterceptorActionT7<TTarget, T1, T2, T3, T4, T5, T6, T7>
{
    ...
    readonly Action<TTarget, T1, T2, T3, T4, T5, T6, T7> originalMethodInternal;

    internal InstanceInterceptorActionT7(Interceptor interceptor, Action<TTarget, T1, T2, T3, T4, T5, T6, T7> originalMethodInternal)
    {
...
public static partial class InstanceInterceptorExtensions
{
    ...
    public static InstanceInterceptorActionT7<TTarget, T1, T2, T3, T4, T5, T6, T7> InstanceJitest<TTarget, T1, T2, T3, T4, T5, T6, T7>(this TTarget instance, string methodName, out Action<T1, T2, T3, T4, T5, T6, T7> originalMethod)
    {
        ...
        var interceptor = instance.Jitest<Action<TTarget, T1, T2, T3, T4, T5, T6, T7>>(methodName, out var originalMethodInternal);
        originalMethod = (t1, t2, t3, t4, t5, t6, t7) => originalMethodInternal.Invoke(instance, t1, t2, t3, t4, t5, t6, t7);
        return new InstanceInterceptorActionT7<TTarget, T1, T2, T3, T4, T5, T6, T7>(interceptor, originalMethodInternal);
    }
}
