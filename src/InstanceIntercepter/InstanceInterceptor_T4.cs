...
public sealed class InstanceInterceptor<TTarget, T1, T2, T3, T4>
{
    ...
    public DetourScope Intercept(TTarget instance, Action<T1, T2, T3, T4> replacement)
    {
        ...
        var orig = originalMethod != null ? (Action<T1, T2, T3, T4>)(object)originalMethod : null;
    ...
    {
        if (replacement == null) throw new ArgumentNullException(nameof(replacement));
        var orig = originalMethod != null ? (Func<T1, T2, T3, T4>)(object)originalMethod : null;
        Func<TTarget, T1, T2, T3, T4> actual = (TTarget self, T1 t1, T2 t2, T3 t3) =>
            object.ReferenceEquals(self, instance)
                ...
                : (orig != null ? orig.Invoke(t1, t2, t3) : default!);
        return DetourScope.Create(target, actual, instance);
    }
...
public static class InstanceInterceptorExtensions_T4
{
    /// <summary>Extension method for instance method interceptor.</summary>
    public static InstanceInterceptor<TTarget, T1, T2, T3, T4> InstanceJitest<TTarget, T1, T2, T3, T4>(this TTarget instance, string methodName, out Action<T1, T2, T3, T4>? originalMethod)
    {
        ...
        if (typeof(TTarget).IsValueType)
        {
            ...
            originalMethod = null;
            return new InstanceInterceptor<TTarget, T1, T2, T3, T4>(method, null);
        }
        else
        {
            var (method, dele) = ResolveMethodHelper.ResolveMethod<Action<T1, T2, T3, T4>>(typeof(TTarget), methodName);
            originalMethod = dele;
            return new InstanceInterceptor<TTarget, T1, T2, T3, T4>(method, dele);
        }
    }
    /// <summary>Extension method for instance method interceptor.</summary>
    public static InstanceInterceptor<TTarget, T1, T2, T3, T4> InstanceJitest<TTarget, T1, T2, T3, T4>(this TTarget instance, string methodName, out Func<T1, T2, T3, T4>? originalMethod)
    {
        if (instance == null) throw new ArgumentNullException(nameof(instance));
        if (typeof(TTarget).IsValueType)
        {
        ...
        {
            var (method, dele) = ResolveMethodHelper.ResolveMethod<Func<T1, T2, T3, T4>>(typeof(TTarget), methodName);
            originalMethod = dele;
            return new InstanceInterceptor<TTarget, T1, T2, T3, T4>(method, dele);
        }
    }
