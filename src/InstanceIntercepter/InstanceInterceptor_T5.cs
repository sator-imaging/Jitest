...
public sealed class InstanceInterceptor<TTarget, T1, T2, T3, T4, T5>
{
    ...
    public DetourScope Intercept(TTarget instance, Action<T1, T2, T3, T4, T5> replacement)
    {
        ...
        var orig = originalMethod != null ? (Action<T1, T2, T3, T4, T5>)(object)originalMethod : null;
        Action<TTarget, T1, T2, T3, T4, T5> actual = (TTarget self, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) =>
        {
            ...
            else orig?.Invoke(t1, t2, t3, t4, t5);
        };
    ...
    {
        if (replacement == null) throw new ArgumentNullException(nameof(replacement));
        var orig = originalMethod != null ? (Func<T1, T2, T3, T4, T5>)(object)originalMethod : null;
        Func<TTarget, T1, T2, T3, T4, T5> actual = (TTarget self, T1 t1, T2 t2, T3 t3, T4 t4) =>
            object.ReferenceEquals(self, instance)
                ...
                : (orig != null ? orig.Invoke(t1, t2, t3, t4) : default!);
        return DetourScope.Create(target, actual, instance);
    }
...
public static class InstanceInterceptorExtensions_T5
{
    /// <summary>Extension method for instance method interceptor.</summary>
    public static InstanceInterceptor<TTarget, T1, T2, T3, T4, T5> InstanceJitest<TTarget, T1, T2, T3, T4, T5>(this TTarget instance, string methodName, out Action<T1, T2, T3, T4, T5>? originalMethod)
    {
        ...
        if (typeof(TTarget).IsValueType)
        {
            ...
            originalMethod = null;
            return new InstanceInterceptor<TTarget, T1, T2, T3, T4, T5>(method, null);
        }
        else
        {
            var (method, dele) = ResolveMethodHelper.ResolveMethod<Action<T1, T2, T3, T4, T5>>(typeof(TTarget), methodName);
            originalMethod = dele;
            return new InstanceInterceptor<TTarget, T1, T2, T3, T4, T5>(method, dele);
        }
    }
    /// <summary>Extension method for instance method interceptor.</summary>
    public static InstanceInterceptor<TTarget, T1, T2, T3, T4, T5> InstanceJitest<TTarget, T1, T2, T3, T4, T5>(this TTarget instance, string methodName, out Func<T1, T2, T3, T4, T5>? originalMethod)
    {
        if (instance == null) throw new ArgumentNullException(nameof(instance));
        if (typeof(TTarget).IsValueType)
        {
        ...
        {
            var (method, dele) = ResolveMethodHelper.ResolveMethod<Func<T1, T2, T3, T4, T5>>(typeof(TTarget), methodName);
            originalMethod = dele;
            return new InstanceInterceptor<TTarget, T1, T2, T3, T4, T5>(method, dele);
        }
    }
