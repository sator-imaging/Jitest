...
public sealed class InstanceInterceptorActionT9<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
    ...
    readonly Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>? originalMethod;

    internal InstanceInterceptorActionT9(Interceptor interceptor, Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>? originalMethod)
    {
    ...
    public DetourScope Intercept(TTarget instance, Action<T1, T2, T3, T4, T5, T6, T7, T8, T9> replacement)
    {
        ...
        Action<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9> actual = (TTarget self, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9) =>
        {
            ...
            else originalMethod?.Invoke(t1, t2, t3, t4, t5, t6, t7, t8, t9);
        };
...
public static partial class InstanceInterceptorExtensions
{
    ...
    public static InstanceInterceptorActionT9<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9> InstanceJitest<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this TTarget instance, string methodName, out Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>? originalMethod)
    {
        ...
        var interceptor = instance.Jitest<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>>(methodName, out originalMethod);
        return new InstanceInterceptorActionT9<TTarget, T1, T2, T3, T4, T5, T6, T7, T8, T9>(interceptor, originalMethod);
    }
}
