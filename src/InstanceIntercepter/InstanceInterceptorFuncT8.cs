...
public sealed class InstanceInterceptorFuncT8<TTarget, T1, T2, T3, T4, T5, T6, T7, T8>
{
    ...
    internal InstanceInterceptorFuncT8(MethodInfo target, Delegate? originalMethod)
    {
    ...
    public DetourScope Intercept(TTarget instance, Func<T1, T2, T3, T4, T5, T6, T7, T8> replacement)
    {
        ...
        var orig = originalMethod != null ? (Func<TTarget, T1, T2, T3, T4, T5, T6, T7, T8>)(object)originalMethod : null;
        Func<TTarget, T1, T2, T3, T4, T5, T6, T7, T8> actual = (TTarget self, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) =>
            object.ReferenceEquals(self, instance)
                ...
                : (orig != null ? orig.Invoke(self, t1, t2, t3, t4, t5, t6, t7) : default!);
