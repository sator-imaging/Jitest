...
public sealed class InstanceInterceptorActionT7<TTarget, T1, T2, T3, T4, T5, T6, T7>
{
    ...
    readonly Action<T1, T2, T3, T4, T5, T6, T7>? originalMethod;

    internal InstanceInterceptorActionT7(Interceptor interceptor, Action<T1, T2, T3, T4, T5, T6, T7> originalMethod)
    {
    ...
    public DetourScope Intercept(TTarget instance, Action<T1, T2, T3, T4, T5, T6, T7> replacement)
    {
        ...
        {
            if (typeof(TTarget).IsValueType ? EqualityComparer<TTarget>.Default.Equals(self, instance) : object.ReferenceEquals(self, instance)) replacement.Invoke(t1, t2, t3, t4, t5, t6, t7);
            else originalMethod.Invoke(t1, t2, t3, t4, t5, t6, t7);
        };
...
public static partial class InstanceInterceptorExtensions
{
    ...
    public static InstanceInterceptorActionT7<TTarget, T1, T2, T3, T4, T5, T6, T7> InstanceJitest<TTarget, T1, T2, T3, T4, T5, T6, T7>(this TTarget instance, string methodName, out Action<T1, T2, T3, T4, T5, T6, T7>? originalMethod)
    {
        ...
        var interceptor = instance.Jitest<Action<T1, T2, T3, T4, T5, T6, T7>>(methodName, out originalMethod);
        return new InstanceInterceptorActionT7<TTarget, T1, T2, T3, T4, T5, T6, T7>(interceptor, originalMethod);
    }
}
